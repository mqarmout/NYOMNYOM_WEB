...
export function ProjectsProvider({ children }) {
  ...
  const addProject = useCallback(async (fields) => {
    const res = await apiFetch('/api/dev-projects', { method: 'POST', body: JSON.stringify(fields) });
  ...
  return (
    <ProjectsContext.Provider value={{
      projects, kanbanTasks, commits, toast,
      loadAll,
      addProject, updateProject, deleteProject, fetchCommit,
...
export function useDevProjects() { return useContext(ProjectsContext); }
