        ...
        <div style={{ display: "flex", gap: 12 }}>
          ...
          <div className="field" style={{ flex: 1 }}>
            ...
            <input
              ...
              min="1"
              value={offMin}
              onChange={(e) => setOffMin(e.target.value)}
            />
          </div>
        </div>
        <button
          ...
          onClick={() =>
            onSave({ enabled: !!enabled, on_duration_min: +onMin, off_duration_min: +offMin })
          }
        >
          Save Schedule
        </button>
    ...
    <div className="screen">
      <div className="page-header">
        <div>
          ...
          <p>
            {r
              ? `Last reading: ${r.recorded_at?.slice(0, 16).replace("T", " ")}`
              : "No readings yet"}
          </p>
        </div>
        <button
      ...
      <div className="finance-cards" style={{ marginBottom: 24 }}>
        <MetricCard
          label="pH"
          value={r?.ph?.toFixed(1)}
          unit=""
          color={phColor}
          sub={
            r
              ? r.ph < PH_IDEAL[0] || r.ph > PH_IDEAL[1]
                ? "out of range"
                : "ideal"
              : "target 5.5–6.5"
          }
      ...
      <div className="finance-cards" style={{ marginBottom: 24 }}>
        ...
        <div className="finance-card" style={{ flex: 2 }}>
          ...
          <div className="fc-amount" style={{ fontSize: 28 }}>
            {activePlants.length}
          </div>
              ...
              <div className="tx-item" key={log.id}>
                <div className="tx-info">
                  <div className="tx-name">
                    {log.trigger_type === "manual" ? "Manual trigger" : "Scheduled run"}
                  </div>
