    ...
    const handler = (e) => {
      ...
      if (
        ...
        setForm((f) => {
          ...
          const next =
            TYPES[(cur + (e.key === "ArrowRight" ? 1 : -1) + TYPES.length) % TYPES.length];
      ...
      <div className="modal-box" style={{ width: 560 }}>
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 18 }}>
          {["boulder", "sport"].map((t) => (
            ...
            >
              {t === "boulder" ? (
                <>
                  <Px name="target" size={12} /> Boulder
                </>
              ) : (
                <>
                  <Px name="arrow-up" size={12} /> Sport
                </>
              )}
            </button>
          ))}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0 16px" }}>
          ...
          <div className="field">
            ...
            <input
              value={form.setter_grade}
              onChange={(e) => set("setter_grade", e.target.value)}
              placeholder="V4, 5.11a..."
            />
          </div>
          <div className="field">
            ...
            <input
              value={form.my_grade}
              onChange={(e) => set("my_grade", e.target.value)}
              placeholder="V5, 5.11c..."
            />
          </div>
          <div className="field">
    ...
    <div className={styles.climbCard}>
      ...
      <div className={styles.climbCardBody}>
        ...
        <div className={styles.climbCardMeta}>
          ...
          {climb.wall_type && (
            <span>
              <Px name="wall" size={11} /> {climb.wall_type}
            </span>
          )}
          <span>
            <ICal /> {climb.date}
...
export default function Climbs() {
  ...
  const filtered = filter === "all" ? climbs : climbs.filter((c) => c.climb_type === filter);
