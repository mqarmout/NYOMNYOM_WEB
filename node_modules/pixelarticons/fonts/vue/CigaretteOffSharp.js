...
export const CigaretteOffSharp = defineComponent({
  name: 'CigaretteOffSharp',
  props: {
    class: {
      type: String,
      default: ''
  ...
  setup(props, { attrs }) {
    return () => h(
      ...
      [
        h('path', {"d": "M2 11h2v6H2zm2 0h9v2H4zm0 4h13v2H4zm3-2h2v2H7zm10-2h3v2h-3zm3 0h2v6h-2z", "fillRule": "evenodd"}),
